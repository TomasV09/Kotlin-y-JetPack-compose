...
import com.example.compose6.screens.NewsViewModel;
import com.example.compose6.screens.NewsViewModel_HiltModules;
...
public final class DaggerNewsApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends NewsApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_example_compose6_screens_NewsViewModel, NewsViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_compose6_screens_NewsViewModel = "com.example.compose6.screens.NewsViewModel";

      @KeepFieldType
      NewsViewModel com_example_compose6_screens_NewsViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends NewsApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_example_compose6_screens_NewsViewModel, ((Provider) newsViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.compose6.screens.NewsViewModel 
  ...
  private static final class SingletonCImpl extends NewsApplication_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.compose6.NewsRepository 
          return (T) new NewsRepository(singletonCImpl.provideNewsApiServiceProvider.get());

          case 1: // com.example.compose6.NewsApiService 
